...
public class ColorPickerDialog extends Dialog {
    ...
    private class ColorPickerView extends View {
        ...
        ColorPickerView(Context c, OnColorChangedListener l, int color) {
            super(c);
            mListener = l;
            mColors = new int[] {0XFF000000, 0xFFFF0000, 0xFFFF00FF, 0xFF0000FF, 0xFF00FFFF, 0xFF00FF00, 0xFFFFFF00, 0xFFFF0000, 0XFFFFFFFF};
    ...
    private final int CENTER_X;// = 100;
    ...
    public ColorPickerDialog(Context context, OnColorChangedListener listener, int initialColor) {
        ...
        CENTER_X = context.getResources().getDisplayMetrics().widthPixels/4;
        CENTER_Y = CENTER_X;
